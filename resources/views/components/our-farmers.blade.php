                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="box-farmer img-hover pb-30 wow fadeInUp" data-wow-delay="0s">
                                <div class="image hover-item">
                                    <img src="./images/widget/farmer-1.jpg" data-src="./images/widget/farmer-1.jpg" alt="" class="lazyload">
                                </div>
                                <div class="content">
                                    <div class="author-wrap">
                        ...
                        <div class="col-lg-4">
                            <div class="box-farmer img-hover pb-30 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="image hover-item">
                                    <img src="./images/widget/farmer-2.jpg" data-src="./images/widget/farmer-2.jpg" alt="" class="lazyload">
                                </div>
                                <div class="content">
                                    <div class="author-wrap">
                                        <div class="has-border">
                        ...
                        <div class="col-lg-4">
                            <div class="box-farmer img-hover  wow fadeInUp" data-wow-delay="0.2s">
                                <div class="image hover-item">
                                    <img src="./images/widget/farmer-3.jpg" data-src="./images/widget/farmer-3.jpg" alt="" class="lazyload">
                                </div>
                                <div class="content">
                                    <div class="author-wrap">
                                        <div class="has-border">
