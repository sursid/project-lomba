                                    ...
                                    <div class="col-lg-9">
                                        <div class="shop-section my-8">
                                            <ul class="nav gap-2" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <a href="marketplace-details.html" class="cmn-btn active">Product Description</a>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                        ...
                                        <div class="tab-content">
                                            <div class="description">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias exercitationem accusamus deleniti dolores architecto officiis cupiditate magnam pariatur dignissimos odit illo officia quisquam, repellat harum consequatur dolore dolor. Magnam similique voluptate excepturi rem dignissimos, vel culpa exercitationem cupiditate veniam voluptatem, perspiciatis dolores. Voluptas nisi a unde ex doloremque, neque architecto?</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
