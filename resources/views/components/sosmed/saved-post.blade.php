                ...
                <div class="col-xl-9 col-lg-8 cus-mar">
                    ...
                    <div class="single-box filter-single-box text-start p-5 p-md-3 d-grid d-xl-flex align-items-center gap-4">
                        <div class="avatar-area">
                            <a href="#"><img src="{{ asset('assets/images/save-post-avatar-1.png') }}" class="max-un" alt="icon"></a>
                        </div>
                        <div class="title-area">
                            ...
                            <div class="inside-profile pt-3 pb-4">
                                <div class="avatar-area d-flex align-items-center gap-3">
                                    <a href="#"><img src="{{ asset('assets/images/avatar-5.png') }}" class="max-un" alt="icon"></a>
                                    <p class="mdtxt">Saved from Atikur Rahman's post in UI/UX DESIGN COMMUNITY</p>
                                </div>
                            </div>
                    ...
                    <div class="single-box filter-single-box text-start p-5 p-md-3 d-grid d-xl-flex align-items-center gap-4">
                        <div class="avatar-area">
                            <a href="#"><img src="{{ asset('assets/images/save-post-avatar-2.png') }}" class="max-un" alt="icon"></a>
                        </div>
                        <div class="title-area">
                            ...
                            <div class="inside-profile pt-3 pb-4">
                                <div class="avatar-area d-flex align-items-center gap-3">
                                    <a href="#"><img src="{{ asset('assets/images/avatar-2.png') }}" class="max-un" alt="icon"></a>
                                    <p class="mdtxt">Saved from Atikur Rahman's post in UI/UX DESIGN COMMUNITY</p>
                                </div>
                            </div>
                            <div class="btn-item d-flex gap-3">
                    ...
                    <div class="single-box filter-single-box text-start p-5 p-md-3 d-grid d-xl-flex align-items-center gap-4">
                        <div class="avatar-area">
                            <a href="#"><img src="{{ asset('assets/images/save-post-avatar-3.png') }}" class="max-un" alt="icon"></a>
                        </div>
                        <div class="title-area">
                            ...
                            <div class="inside-profile pt-3 pb-4">
                                <div class="avatar-area d-flex align-items-center gap-3">
                                    <a href="#"><img src="{{ asset('assets/images/avatar-3.png') }}" class="max-un" alt="icon"></a>
                                    <p class="mdtxt">Saved from Atikur Rahman's post in UI/UX DESIGN COMMUNITY</p>
                                </div>
                            </div>
                            <div class="btn-item d-flex gap-3">
                    ...
                    <div class="single-box filter-single-box text-start p-5 p-md-3 d-grid d-xl-flex align-items-center gap-4">
                        <div class="avatar-area">
                            <a href="#"><img src="{{ asset('assets/images/save-post-avatar-4.png') }}" class="max-un" alt="icon"></a>
                        </div>
                        <div class="title-area">
                            ...
                            <div class="inside-profile pt-3 pb-4">
                                <div class="avatar-area d-flex align-items-center gap-3">
                                    <a href="#"><img src="{{ asset('assets/images/avatar-9.png') }}" class="max-un" alt="icon"></a>
                                    <p class="mdtxt">Saved from Atikur Rahman's post in UI/UX DESIGN COMMUNITY</p>
                                </div>
                            </div>
                            <div class="btn-item d-flex gap-3">
                    ...
                    <div class="single-box filter-single-box text-start p-5 p-md-3 d-grid d-xl-flex align-items-center gap-4">
                        <div class="avatar-area">
                            <a href="#"><img src="{{ asset('assets/images/save-post-avatar-5.png') }}" class="max-un" alt="icon"></a>
                        </div>
                        <div class="title-area">
                            ...
                            <div class="inside-profile pt-3 pb-4">
                                <div class="avatar-area d-flex align-items-center gap-3">
                                    <a href="#"><img src="{{ asset('assets/images/avatar-4.png') }}" class="max-un" alt="icon"></a>
                                    <p class="mdtxt">Saved from Atikur Rahman's post in UI/UX DESIGN COMMUNITY</p>
                                </div>
                            </div>
                            <div class="btn-item d-flex gap-3">
