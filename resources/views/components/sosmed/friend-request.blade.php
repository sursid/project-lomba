                ...
                <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="profile-sidebar cus-scrollbar p-5">
                        ...
                        <ul class="profile-link mt-7 mb-7 pb-7">
                            <li>
                                <a href="friend-request.html" class="d-flex gap-4 active">
                    ...
                    <div class="row cus-mar friend-request">
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-1.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 mb-2 mt-3">Arest Liolestin</h6></a>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-2.png') }}" alt="avatar">
                                </div>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-3.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 mb-2 mt-3">Leslie Alexander</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-4.png') }}" alt="avatar">
                                </div>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-5.png') }}" alt="avatar">
                                </div>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-6.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 mb-2 mt-3">Savannah Nguyen</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-7.png') }}" alt="avatar">
                                </div>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-8.png') }}" alt="avatar">
                                </div>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-9.png') }}" alt="avatar">
                                </div>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-10.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 mb-2 mt-3">Darlene Robertson</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-11.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 mb-2 mt-3">Arlene McCoy</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/confirm-friend-12.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 mb-2 mt-3">Bessie Cooper</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
