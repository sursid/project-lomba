                ...
                <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="profile-sidebar cus-scrollbar p-5">
                        ...
                        <ul class="profile-link mt-7 mb-7 pb-7">
                            ...
                            <li>
                                <a href="suggestions.html" class="d-flex gap-4 active">
                    ...
                    <div class="row cus-mar friend-request">
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-1.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Marvin McKinney</h6></a>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-2.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Darlene Robertson</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-3.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Jerome Bell</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-4.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Cameron Williamson</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-5.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Courtney Henry</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-6.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Ralph Edwards</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-7.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Robert Fox</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-8.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Cody Fisher</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-9.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Ronald Richards</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-10.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Brooklyn Simmons</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-11.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Devon Lane</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
                        ...
                        <div class="col-xl-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                <div class="avatar">
                                    <img class="avatar-img w-100" src="{{ asset('assets/images/suggestion-img-12.png') }}" alt="avatar">
                                </div>
                                <a href="public-profile-post.html"><h6 class="m-0 my-2">Jenny Wilson</h6></a>
                                <div class="friends-list d-center gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                        <li><img src="{{ asset('assets/images/avatar-3.png') }}" alt="image"></li>
