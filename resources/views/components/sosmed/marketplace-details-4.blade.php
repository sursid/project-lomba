                                    ...
                                    <div class="col-lg-9">
                                        <div class="shop-section my-8">
                                            <ul class="nav gap-2" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a href="marketplace-details-4.html" class="cmn-btn active">Author</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="tab-content">
                                            <div class="author">
                                                <h5 class="mb-3">Item Author</h5>
                                                <div class="profile-area d-flex my-5 gap-3">
                                                    ...
                                                    <div class="text-area">
                                                        ...
                                                        <span class="fs-6">29 items published</span>
                                                    </div>
                                                </div>
                                                <a class="cmn-btn" href="marketplace-post.html">View Author's Store</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
