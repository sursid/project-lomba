                        ...
                        <div class="single-box p-5">
                            ...
                            <div class="page-details">
                                <ul class="nav mt-5 pt-4 flex-wrap gap-2 tab-area">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="marketplace-group.html" class="nav-link d-center active">Groups</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                    ...
                    <div class="row cus-mar friend-request">
                        <div class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                ...
                                <a href="group-details.html"><h6 class="m-0 my-2">Travel Moon</h6></a>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                ...
                                <a href="group-details.html"><h6 class="m-0 my-2">Car Legend Community</h6></a>
                                <p class="smtxt public-group">Public Group</p>
                                <div class="friends-list d-center mt-3 gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                ...
                                <a href="group-details.html"><h6 class="m-0 my-2">Travel World</h6></a>
                                <p class="smtxt public-group">Public Group</p>
                                <div class="friends-list d-center mt-3 gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                ...
                                <a href="group-details.html"><h6 class="m-0 my-2">Beatty Community</h6></a>
                                <p class="smtxt public-group">Public Group</p>
                                <div class="friends-list d-center mt-3 gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                ...
                                <a href="group-details.html"><h6 class="m-0 my-2">Event Group</h6></a>
                                <p class="smtxt public-group">Public Group</p>
                                <div class="friends-list d-center mt-3 gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                ...
                                <a href="group-details.html"><h6 class="m-0 my-2">Fun Make Society</h6></a>
                                <p class="smtxt public-group">Public Group</p>
                                <div class="friends-list d-center mt-3 gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                ...
                                <a href="group-details.html"><h6 class="m-0 my-2">Travel Africa</h6></a>
                                <p class="smtxt public-group">Public Group</p>
                                <div class="friends-list d-center mt-3 gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                ...
                                <a href="group-details.html"><h6 class="m-0 my-2">World Travel Community</h6></a>
                                <p class="smtxt public-group">Public Group</p>
                                <div class="friends-list d-center mt-3 gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-lg-4 col-sm-6 col-8">
                            <div class="single-box p-5">
                                ...
                                <a href="group-details.html"><h6 class="m-0 my-2">Fashion Hop</h6></a>
                                <p class="smtxt public-group">Public Group</p>
                                <div class="friends-list d-center mt-3 gap-1 text-center">
                                    <ul class="d-center">
                                        <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
