                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-6 cus-z2">
                    ...
                    <div class="profile-sidebar cus-scrollbar p-5">
                        ...
                        <ul class="profile-link mt-7 mb-7 pb-7">
                            ...
                            <li>
                                <a href="saved-post.html" class="d-flex gap-4 active">
                            ...
                            <div class="top-area pb-5">
                                <div class="profile-area d-center justify-content-between">
                                    <div class="avatar-item d-flex gap-3 align-items-center">
                                        <div class="avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/avatar-12.png') }}" alt="avatar">
                                        </div>
                                        <div class="info-area">
                                ...
                                <div class="py-4 description-item">
                                    <p class="description mb-6">Nam ornare a nibh id sagittis. Vestibulum nec molestie urna, eget convallis mi. Vestibulum rhoncus ligula eget sem sollicitudin interdum. Aliquam massa lectus, fringilla non diam ut, laoreet convallis risus. Curabitur at metus imperdiet, pellentesque ligula vel, Requirements:</p>
                                    <ul>
                                        <li>At least 1 year of professional job experience</li>
                                        <li>A strong portfolio of related design work for both web and mobile platforms</li>
                                        <li>Experience in planning and conducting user research, user testing, A/B testing, rapid prototyping, usability testing</li>
                                        <li>Understanding and execution of user-centered design (UCD)</li>
                                        <li>Proficient in Figma (is a must), Adobe Xd, Invision etc.</li>
                                        <li>Knowledge of Adobe illustrator and Photoshop is a plus</li>
                                        <li>Professional written and interpersonal skills when communicating with customers and stakeholders</li>
                                        <li>Knowledge about design principles, patterns, and familiarity with the leading design systems like Human Interface Guidelines, Material Design, etc.</li>
                                        <li>Ability to priorities and manage several milestones and projects efficiently</li>
                                    </ul>
                                    <p class="mt-4">Job Description:</p>
                                    <ul>
                                        <li>Understand product specifications, business needs and create the design to deliver a user-friendly interface</li>
                                ...
                                <div class="post-img">
                                    <img src="{{ asset('assets/images/post-img-7.png') }}" class="w-100" alt="image">
                                </div>
                            </div>
