        ...
        <div class="container">
                            ...
                            <div class="page-details">
                                <ul class="nav mt-5 pt-4 flex-wrap gap-2 tab-area">
                                    <li class="nav-item" role="presentation">
                                        <a href="marketplace-post.html" class="nav-link d-center">Post</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="marketplace-videos.html" class="nav-link d-center">Videos</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="marketplace-market.html" class="nav-link d-center active">Marketplace</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xxl-9 col-xl-8">
                    <div class="best-sellers-area mb-5 d-center flex-wrap gap-3 justify-content-between">
                        <ul class="nav flex-wrap gap-2 tab-area" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center active" id="best-sellers-tab" data-bs-toggle="tab" data-bs-target="#best-sellers-tab-pane" type="button" role="tab" aria-controls="best-sellers-tab-pane" aria-selected="true">best sellers</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center" id="recently-added-tab" data-bs-toggle="tab" data-bs-target="#recently-added-tab-pane" type="button" role="tab" aria-controls="recently-added-tab-pane" aria-selected="false" tabindex="-1">recently added</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center" id="best-rated-tab" data-bs-toggle="tab" data-bs-target="#best-rated-tab-pane" type="button" role="tab" aria-controls="best-rated-tab-pane" aria-selected="false" tabindex="-1">best rated</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center" id="lowest-price-tab" data-bs-toggle="tab" data-bs-target="#lowest-price-tab-pane" type="button" role="tab" aria-controls="lowest-price-tab-pane" aria-selected="false" tabindex="-1">lowest price</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center" id="highest-price-tab" data-bs-toggle="tab" data-bs-target="#highest-price-tab-pane" type="button" role="tab" aria-controls="highest-price-tab-pane" aria-selected="false" tabindex="-1">highest price</button>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="best-sellers-tab-pane" role="tabpanel" aria-labelledby="best-sellers-tab" tabindex="0">
                            <div class="row cus-mar">
                                <div class="col-xl-6 col-lg-8 col-md-6">
                                    <div class="single-box marketplace-item p-2 p-sm-5">
                                        <div class="avatar-area position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/marketplace-img-4.png') }}" alt="avatar">
                                            <h5 class="position-absolute price-box">$49</h5>
                                        </div>
                                        <div class="info-box mt-12 text-start">
                                            <a href="marketplace-details.html"><h5>Schoolchild Backpack</h5></a>
                                        </div>
                                        <div class="head-area mt-5 d-flex justify-content-between">
                                            <div class="d-flex w-100 gap-3 align-items-center justify-content-between">
                                                <div class="d-flex gap-3 align-items-center">
                                                    ...
                                                    <div class="text-area text-start">
                                                        <h6 class="m-0 mb-1"><a href="public-profile-post.html">Travel Moon</a></h6>
                                ...
                                <div class="col-xl-6 col-lg-8 col-md-6">
                                    <div class="single-box marketplace-item p-2 p-sm-5">
                                        <div class="avatar-area position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/marketplace-img-1.png') }}" alt="avatar">
                                            <h5 class="position-absolute price-box">$49</h5>
                                        </div>
                                        <div class="info-box mt-12 text-start">
                                            <a href="marketplace-details.html"><h5>Men's watch</h5></a>
                                        </div>
                                        <div class="head-area mt-5 d-flex justify-content-between">
                                            <div class="d-flex w-100 gap-3 align-items-center justify-content-between">
                                                <div class="d-flex gap-3 align-items-center">
                                ...
                                <div class="col-xl-6 col-lg-8 col-md-6">
                                    <div class="single-box marketplace-item p-2 p-sm-5">
                                        <div class="avatar-area position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/marketplace-img-2.png') }}" alt="avatar">
                                            <h5 class="position-absolute price-box">$49</h5>
                                        </div>
                                        <div class="info-box mt-12 text-start">
                                            <a href="marketplace-details.html"><h5>Digital Camera</h5></a>
                                        </div>
                                        <div class="head-area mt-5 d-flex justify-content-between">
                                            <div class="d-flex w-100 gap-3 align-items-center justify-content-between">
                                                <div class="d-flex gap-3 align-items-center">
                                ...
                                <div class="col-xl-6 col-lg-8 col-md-6">
                                    <div class="single-box marketplace-item p-2 p-sm-5">
                                        <div class="avatar-area position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/marketplace-img-3.png') }}" alt="avatar">
                                            <h5 class="position-absolute price-box">$49</h5>
                                        </div>
                                        <div class="info-box mt-12 text-start">
                                            <a href="marketplace-details.html"><h5>Laptop</h5></a>
                                        </div>
                                        <div class="head-area mt-5 d-flex justify-content-between">
                                            <div class="d-flex w-100 gap-3 align-items-center justify-content-between">
                                                <div class="d-flex gap-3 align-items-center">
                        ...
                        <div class="tab-pane fade" id="recently-added-tab-pane" role="tabpanel" aria-labelledby="recently-added-tab" tabindex="0">
                            <div class="row cus-mar">
                                <div class="col-xl-6 col-lg-8 col-md-6">
                                    <div class="single-box marketplace-item p-2 p-sm-5">
                                        <div class="avatar-area position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/marketplace-img-5.png') }}" alt="avatar">
                                            <h5 class="position-absolute price-box">$49</h5>
                                        </div>
                                        <div class="info-box mt-12 text-start">
                                            <a href="marketplace-details.html"><h5>Women Heeled Shoes</h5></a>
                                        </div>
                                        <div class="head-area mt-5 d-flex justify-content-between">
                                            <div class="d-flex w-100 gap-3 align-items-center justify-content-between">
                                                <div class="d-flex gap-3 align-items-center">
                        ...
                        <div class="tab-pane fade" id="best-rated-tab-pane" role="tabpanel" aria-labelledby="best-rated-tab" tabindex="0">
                            <div class="row cus-mar">
                                <div class="col-xl-6 col-lg-8 col-md-6">
                                    <div class="single-box marketplace-item p-2 p-sm-5">
                                        <div class="avatar-area position-relative">
                        ...
                        <div class="tab-pane fade" id="lowest-price-tab-pane" role="tabpanel" aria-labelledby="lowest-price-tab" tabindex="0">
                            <div class="row cus-mar">
                                <div class="col-xl-6 col-lg-8 col-md-6">
                                    <div class="single-box marketplace-item p-2 p-sm-5">
                                        <div class="avatar-area position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/marketplace-img-6.png') }}" alt="avatar">
                                            <h5 class="position-absolute price-box">$49</h5>
                                        </div>
                                        <div class="info-box mt-12 text-start">
                                            <a href="marketplace-details.html"><h5>Headphone</h5></a>
                                        </div>
                                        <div class="head-area mt-5 d-flex justify-content-between">
                                            <div class="d-flex w-100 gap-3 align-items-center justify-content-between">
                                                <div class="d-flex gap-3 align-items-center">
                        ...
                        <div class="tab-pane fade" id="highest-price-tab-pane" role="tabpanel" aria-labelledby="highest-price-tab" tabindex="0">
                            <div class="row cus-mar">
                                <div class="col-xl-6 col-lg-8 col-md-6">
                                    <div class="single-box marketplace-item p-2 p-sm-5">
                                        <div class="avatar-area position-relative">
