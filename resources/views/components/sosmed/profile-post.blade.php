                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-6 cus-z2">
                    ...
                    <div class="profile-sidebar cus-scrollbar max-width p-5">
                        ...
                        <div class="sidebar-area">
                            ...
                            <a href="#" class="cmn-btn w-100 mt-5 alt third d-center gap-1">
                                <i class="material-symbols-outlined mat-icon fs-2"> edit_note </i>
                                Edit Bio
                            </a>
                        </div>
                        <div class="sidebar-area mt-5">
                            ...
                            <ul class="d-grid gap-2 mt-4">
                                ...
                                <li class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="mdtxt link"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cfbbaabcbb8fa2aea6a3e1aca0a2">[email&#160;protected]</a></span>
                                </li>
                                <li class="d-flex align-items-center gap-2">
