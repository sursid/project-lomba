                ...
                <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="profile-sidebar cus-scrollbar p-5">
                        ...
                        <ul class="profile-link mt-7 mb-7 pb-7">
                            ...
                            <li>
                                <a href="event.html" class="d-flex gap-4 active">
                    ...
                    <div class="top-area mb-5 d-center flex-wrap gap-3 justify-content-between">
                        <ul class="nav flex-wrap gap-2 tab-area" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center active" id="top-tab" data-bs-toggle="tab" data-bs-target="#top-tab-pane"
                                    type="button" role="tab" aria-controls="top-tab-pane" aria-selected="true">top</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center" id="local-tab" data-bs-toggle="tab" data-bs-target="#local-tab-pane"
                                    type="button" role="tab" aria-controls="local-tab-pane" aria-selected="false">local</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center" id="online-tab" data-bs-toggle="tab" data-bs-target="#online-tab-pane"
                                    type="button" role="tab" aria-controls="online-tab-pane" aria-selected="false">online</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center" id="saved-tab" data-bs-toggle="tab" data-bs-target="#saved-tab-pane"
