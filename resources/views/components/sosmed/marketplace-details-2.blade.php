                                    ...
                                    <div class="col-lg-9">
                                        <div class="shop-section my-8">
                                            <ul class="nav gap-2" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a href="marketplace-details-2.html" class="cmn-btn active">Shipping</a>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <a href="marketplace-details-3.html" class="cmn-btn alt third">Review</a>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                        ...
                                        <div class="tab-content">
                                            <div class="shipping">
                                                <h4 class="mb-4">Shipping Fee Details</h4>
                                                <ul>
                                                    <li>• All of our products include free shipping within all USA Canada.</li>
                                                    <li>• If you are in California, your order will arrive within 1-2 business days.</li>
                                                    <li>• If you are in any other state of USA, your order will arrive within 2-4 business days.</li>
                                                    <li>• If you are in Canada, your order will arrive within 5-6 business days.</li>
                                                    <li>• If you have any problems with your order, feel free to send us a message at</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
