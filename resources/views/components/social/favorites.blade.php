                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-6 cus-z2">
                    ...
                    <div class="profile-sidebar cus-scrollbar p-5">
                        ...
                        <ul class="profile-link mt-7 mb-7 pb-7">
                            ...
                            <li>
                                <a href="favorites.html" class="d-flex gap-4 active">
                    ...
                    <div class="post-item d-flex flex-column gap-5 gap-md-7">
                        <div class="post-single-box p-3 p-sm-5">
                            <div class="top-area pb-4">
                                <div class="post-img">
                                    <img src="{{ asset('assets/images/post-img-8.png') }}" class="w-100" alt="image">
                                </div>
                                <div class="pt-4">
                        ...
                        <div class="post-single-box p-3 p-sm-5">
                            <div class="top-area pb-5">
                                ...
                                <div class="post-img">
                                    <img src="{{ asset('assets/images/post-img-9.png') }}" class="w-100" alt="image">
                                </div>
                            </div>
                        ...
                        <div class="post-single-box p-3 p-sm-5">
                            <div class="top-area pb-5">
                                ...
                                <div class="post-img  d-flex justify-content-between flex-wrap gap-2 gap-lg-3">
                                    <div class="single">
                                        <img src="{{ asset('assets/images/post-img-10.png') }}" alt="image">
                                    </div>
                                    <div class="single d-grid gap-3">
                                        <img src="{{ asset('assets/images/post-img-11.png') }}" alt="image">
                                        <img src="{{ asset('assets/images/post-img-12.png') }}" alt="image">
                                    </div>
                                </div>
                            </div>
                            <div class="total-react-share pb-4 d-center gap-2 flex-wrap justify-content-between">
