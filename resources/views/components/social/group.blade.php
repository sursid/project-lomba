            ...
            <div class="container">
                <nav class="navbar w-100 navbar-expand-lg justify-content-betweenm">
                    ...
                    <ul class="navbar-nav feed flex-row gap-xl-20 gap-lg-10 gap-sm-7 gap-1 py-4 py-lg-0 m-lg-auto ms-auto ms-aut align-self-center">
                        <li>
                            <a href="index-2.html" class="nav-icon home"><i class="mat-icon fs-xxl material-symbols-outlined mat-icon">home</i></a>
                        </li>
                        <li>
                            <a href="#news-feed" class="nav-icon feed"><i class="mat-icon fs-xxl material-symbols-outlined mat-icon">feed</i></a>
                        </li>
                        <li>
                            <a href="group.html" class="nav-icon active"><i class="mat-icon fs-xxl material-symbols-outlined mat-icon">group</i></a>
                        </li>
                        <li>
                    ...
                    <div class="popular-area mb-5 d-center flex-wrap gap-3 justify-content-between">
                        <ul class="nav flex-wrap gap-2 tab-area" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center active" id="popular-tab" data-bs-toggle="tab" data-bs-target="#popular-tab-pane"
                                    type="button" role="tab" aria-controls="popular-tab-pane" aria-selected="true">popular</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center" id="most-member-tab" data-bs-toggle="tab" data-bs-target="#most-member-tab-pane"
                                    type="button" role="tab" aria-controls="most-member-tab-pane" aria-selected="false">most-member</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-center" id="suggested-group-tab" data-bs-toggle="tab" data-bs-target="#suggested-group-tab-pane"
                        ...
                        <div class="tab-pane fade show active" id="popular-tab-pane" role="tabpanel" aria-labelledby="popular-tab" tabindex="0">
                            <div class="row cus-mar friend-request">
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-box position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/group-img-1.png') }}" alt="avatar">
                                        ...
                                        <div class="abs-avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/group-avatar-1.png') }}" alt="avatar">
                                        </div>
                                        <a href="group-details.html"><h6 class="m-0 mb-2 mt-3">Travel Moon</h6></a>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-box position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/group-img-2.png') }}" alt="avatar">
                                            <div class="abs-area w-100 position-absolute top-0 p-3 d-center justify-content-end">
                                                <div class="btn-group cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center px-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="material-symbols-outlined fs-xxl m-0"> more_horiz </i>
                                        ...
                                        <div class="abs-avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/group-avatar-2.png') }}" alt="avatar">
                                        </div>
                                        <a href="group-details.html"><h6 class="m-0 mb-2 mt-3">Car Legend Community</h6></a>
                                        <p class="smtxt public-group">Public Group</p>
                                        <div class="friends-list d-center mt-3 gap-1 text-center">
                                            <ul class="d-center">
                                                <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-box position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/group-img-3.png') }}" alt="avatar">
                                            <div class="abs-area w-100 position-absolute top-0 p-3 d-center justify-content-end">
                                                <div class="btn-group cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center px-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="material-symbols-outlined fs-xxl m-0"> more_horiz </i>
                                        ...
                                        <div class="abs-avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/group-avatar-3.png') }}" alt="avatar">
                                        </div>
                                        <a href="group-details.html"><h6 class="m-0 mb-2 mt-3">Travel World</h6></a>
                                        <p class="smtxt public-group">Public Group</p>
                                        <div class="friends-list d-center mt-3 gap-1 text-center">
                                            <ul class="d-center">
                                                <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-box position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/group-img-4.png') }}" alt="avatar">
                                            <div class="abs-area w-100 position-absolute top-0 p-3 d-center justify-content-end">
                                                <div class="btn-group cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center px-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="material-symbols-outlined fs-xxl m-0"> more_horiz </i>
                                        ...
                                        <div class="abs-avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/group-avatar-4.png') }}" alt="avatar">
                                        </div>
                                        <a href="group-details.html"><h6 class="m-0 mb-2 mt-3">Beatty Community</h6></a>
                                        <p class="smtxt public-group">Public Group</p>
                                        <div class="friends-list d-center mt-3 gap-1 text-center">
                                            <ul class="d-center">
                                                <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-box position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/group-img-5.png') }}" alt="avatar">
                                            <div class="abs-area w-100 position-absolute top-0 p-3 d-center justify-content-end">
                                                <div class="btn-group cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center px-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="material-symbols-outlined fs-xxl m-0"> more_horiz </i>
                                        ...
                                        <div class="abs-avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/group-avatar-5.png') }}" alt="avatar">
                                        </div>
                                        <a href="group-details.html"><h6 class="m-0 mb-2 mt-3">Event Group</h6></a>
                                        <p class="smtxt public-group">Public Group</p>
                                        <div class="friends-list d-center mt-3 gap-1 text-center">
                                            <ul class="d-center">
                                                <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-box position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/group-img-6.png') }}" alt="avatar">
                                            <div class="abs-area w-100 position-absolute top-0 p-3 d-center justify-content-end">
                                                <div class="btn-group cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center px-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="material-symbols-outlined fs-xxl m-0"> more_horiz </i>
                                        ...
                                        <div class="abs-avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/group-avatar-6.png') }}" alt="avatar">
                                        </div>
                                        <a href="group-details.html"><h6 class="m-0 mb-2 mt-3">Fun Make Society</h6></a>
                                        <p class="smtxt public-group">Public Group</p>
                                        <div class="friends-list d-center mt-3 gap-1 text-center">
                                            <ul class="d-center">
                                                <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-box position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/group-img-7.png') }}" alt="avatar">
                                            <div class="abs-area w-100 position-absolute top-0 p-3 d-center justify-content-end">
                                                <div class="btn-group cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center px-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="material-symbols-outlined fs-xxl m-0"> more_horiz </i>
                                        ...
                                        <div class="abs-avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/group-avatar-7.png') }}" alt="avatar">
                                        </div>
                                        <a href="group-details.html"><h6 class="m-0 mb-2 mt-3">Travel Africa</h6></a>
                                        <p class="smtxt public-group">Public Group</p>
                                        <div class="friends-list d-center mt-3 gap-1 text-center">
                                            <ul class="d-center">
                                                <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-box position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/group-img-8.png') }}" alt="avatar">
                                            <div class="abs-area w-100 position-absolute top-0 p-3 d-center justify-content-end">
                                                <div class="btn-group cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center px-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="material-symbols-outlined fs-xxl m-0"> more_horiz </i>
                                        ...
                                        <div class="abs-avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/group-avatar-8.png') }}" alt="avatar">
                                        </div>
                                        <a href="group-details.html"><h6 class="m-0 mb-2 mt-3">World Travel Community</h6></a>
                                        <p class="smtxt public-group">Public Group</p>
                                        <div class="friends-list d-center mt-3 gap-1 text-center">
                                            <ul class="d-center">
                                                <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-box position-relative">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/group-img-9.png') }}" alt="avatar">
                                            <div class="abs-area w-100 position-absolute top-0 p-3 d-center justify-content-end">
                                                <div class="btn-group cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center px-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="material-symbols-outlined fs-xxl m-0"> more_horiz </i>
                                        ...
                                        <div class="abs-avatar-item">
                                            <img class="avatar-img max-un" src="{{ asset('assets/images/group-avatar-9.png') }}" alt="avatar">
                                        </div>
                                        <a href="group-details.html"><h6 class="m-0 mb-2 mt-3">Fashion Hop</h6></a>
                                        <p class="smtxt public-group">Public Group</p>
                                        <div class="friends-list d-center mt-3 gap-1 text-center">
                                            <ul class="d-center">
                                                <li><img src="{{ asset('assets/images/avatar-2.png') }}" alt="image"></li>
