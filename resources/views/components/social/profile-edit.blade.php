                    ...
                    <div class="single-box p-3">
                        ...
                        <div class="upload-single">
                            <div class="profile-picture text-start">
                                <img class="preview-image w-100" src="{{ asset('assets/images/profile-picture.png') }}" alt="Preview Image">
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="upload-single cover-img">
                                    ...
                                    <div class="profile-picture position-relative text-start">
                                        <img class="preview-image w-100" src="{{ asset('assets/images/profile-edit-cover.png') }}" alt="Preview Image">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="head-area mt-5 text-start">
                                        <h6>Bio</h6>
                                        <p class="mdtxt mt-4">“Lorem ipsum dolor sit amet consectetur. Nec donec vestibulum eleifend lectus ipsum ultrices et dictum”.</p>
                                    </div>
                                    <ul class="d-grid gap-3 mt-5">
                                        <li class="d-center gap-3 justify-content-between">
                                            <div class="info-area d-flex text-start align-items-center gap-2">
                                                <i class="material-symbols-outlined mat-icon"> work </i>
                                                <span class="mdtxt">Associate Creative Director – Experience Design</span>
                                            </div>
                                        ...
                                        <li class="d-center gap-3 justify-content-between">
                                            <div class="info-area d-flex text-start align-items-center gap-2">
                                                <i class="material-symbols-outlined mat-icon"> work </i>
                                                <span class="mdtxt">Former Designer at TECHTEK</span>
                                            </div>
                                            <div class="input-item d-center text-start">
                                                <div class="group-btn cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <li class="d-center gap-3 justify-content-between">
                                            <div class="info-area d-flex text-start align-items-center gap-2">
                                                <i class="material-symbols-outlined mat-icon"> work </i>
                                                <span class="mdtxt">Former Designer at Telpino</span>
                                            </div>
                                            <div class="input-item d-center text-start">
                                                <div class="group-btn cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <li class="d-center gap-3 justify-content-between">
                                            <div class="info-area d-flex text-start align-items-center gap-2">
                                                <i class="material-symbols-outlined mat-icon"> school </i>
                                                <span class="mdtxt">Honors (English)</span>
                                            </div>
                                            <div class="input-item d-center text-start">
                                                <div class="group-btn cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <li class="d-center gap-3 justify-content-between">
                                            <div class="info-area d-flex text-start align-items-center gap-2">
                                                <i class="material-symbols-outlined mat-icon"> auto_awesome </i>
                                                <span class="mdtxt">Religione</span>
                                            </div>
                                            <div class="input-item d-center text-start">
                                                <div class="group-btn cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <li class="d-center gap-3 justify-content-between">
                                            <div class="info-area d-flex text-start align-items-center gap-2">
                                                ...
                                                <span class="mdtxt">Relationship (Single)</span>
                                            </div>
                                            <div class="input-item d-center text-start">
                                                <div class="group-btn cus-dropdown dropend">
                                                    <button type="button" class="dropdown-btn d-center" data-bs-toggle="dropdown" aria-expanded="false">
