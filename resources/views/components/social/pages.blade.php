            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="tab-content pages-create">
                        <div class="tab-pane fade show active" id="liked-tab-pane" role="tabpanel" aria-labelledby="liked-tab" tabindex="0">
                            <div class="row cus-mar friend-request">
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/page-img-1.png') }}" alt="avatar">
                                        </div>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/page-img-2.png') }}" alt="avatar">
                                        </div>
                                        <div class="head-area my-5 d-flex justify-content-between">
                                            <div class="d-flex gap-3 align-items-center">
                                                <div class="avatar-item">
                                                    <img class="avatar-img max-un" src="{{ asset('assets/images/page-avatar-2.png') }}" alt="avatar">
                                                </div>
                                                <div class="text-area text-start">
                                                    <h6 class="m-0 mb-1"><a href="pages-details.html">Boyseberry</a></h6>
                                                    <p class="mdtxt">Zara</p>
                                                </div>
                                            </div>
                                            <div class="btn-group bg-transparent cus-dropdown dropend">
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/page-img-3.png') }}" alt="avatar">
                                        </div>
                                        <div class="head-area my-5 d-flex justify-content-between">
                                            <div class="d-flex gap-3 align-items-center">
                                                <div class="avatar-item">
                                                    <img class="avatar-img max-un" src="{{ asset('assets/images/page-avatar-3.png') }}" alt="avatar">
                                                </div>
                                                <div class="text-area text-start">
                                                    <h6 class="m-0 mb-1"><a href="pages-details.html">Cempedak</a></h6>
                                                    <p class="mdtxt">Zara</p>
                                                </div>
                                            </div>
                                            <div class="btn-group bg-transparent cus-dropdown dropend">
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/page-img-4.png') }}" alt="avatar">
                                        </div>
                                        <div class="head-area my-5 d-flex justify-content-between">
                                            <div class="d-flex gap-3 align-items-center">
                                                <div class="avatar-item">
                                                    <img class="avatar-img max-un" src="{{ asset('assets/images/page-avatar-4.png') }}" alt="avatar">
                                                </div>
                                                <div class="text-area text-start">
                                                    <h6 class="m-0 mb-1"><a href="pages-details.html">Acai</a></h6>
                                                    <p class="mdtxt">Zara</p>
                                                </div>
                                            </div>
                                            <div class="btn-group bg-transparent cus-dropdown dropend">
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/page-img-5.png') }}" alt="avatar">
                                        </div>
                                        <div class="head-area my-5 d-flex justify-content-between">
                                            <div class="d-flex gap-3 align-items-center">
                                                <div class="avatar-item">
                                                    <img class="avatar-img max-un" src="{{ asset('assets/images/page-avatar-5.png') }}" alt="avatar">
                                                </div>
                                                <div class="text-area text-start">
                                                    <h6 class="m-0 mb-1"><a href="pages-details.html">Citron</a></h6>
                                                    <p class="mdtxt">Zara</p>
                                                </div>
                                            </div>
                                            <div class="btn-group bg-transparent cus-dropdown dropend">
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/page-img-6.png') }}" alt="avatar">
                                        </div>
                                        <div class="head-area my-5 d-flex justify-content-between">
                                            <div class="d-flex gap-3 align-items-center">
                                                <div class="avatar-item">
                                                    <img class="avatar-img max-un" src="{{ asset('assets/images/page-avatar-6.png') }}" alt="avatar">
                                                </div>
                                                <div class="text-area text-start">
                                                    <h6 class="m-0 mb-1"><a href="pages-details.html">Canistel</a></h6>
                                                    <p class="mdtxt">Zara</p>
                                                </div>
                                            </div>
                                            <div class="btn-group bg-transparent cus-dropdown dropend">
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/page-img-7.png') }}" alt="avatar">
                                        </div>
                                        <div class="head-area my-5 d-flex justify-content-between">
                                            <div class="d-flex gap-3 align-items-center">
                                                <div class="avatar-item">
                                                    <img class="avatar-img max-un" src="{{ asset('assets/images/page-avatar-7.png') }}" alt="avatar">
                                                </div>
                                                <div class="text-area text-start">
                                                    <h6 class="m-0 mb-1"><a href="pages-details.html">Citron</a></h6>
                                                    <p class="mdtxt">Zara</p>
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/page-img-8.png') }}" alt="avatar">
                                        </div>
                                        <div class="head-area my-5 d-flex justify-content-between">
                                            <div class="d-flex gap-3 align-items-center">
                                                <div class="avatar-item">
                                                    <img class="avatar-img max-un" src="{{ asset('assets/images/page-avatar-8.png') }}" alt="avatar">
                                                </div>
                                                <div class="text-area text-start">
                                                    <h6 class="m-0 mb-1"><a href="pages-details.html">Apricot</a></h6>
                                                    <p class="mdtxt">Zara</p>
                                                </div>
                                            </div>
                                            <div class="btn-group bg-transparent cus-dropdown dropend">
                                ...
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                                            <img class="avatar-img w-100" src="{{ asset('assets/images/page-img-9.png') }}" alt="avatar">
                                        </div>
                                        <div class="head-area my-5 d-flex justify-content-between">
                                            <div class="d-flex gap-3 align-items-center">
                                                <div class="avatar-item">
                                                    <img class="avatar-img max-un" src="{{ asset('assets/images/page-avatar-9.png') }}" alt="avatar">
                                                </div>
                                                <div class="text-area text-start">
                                                    <h6 class="m-0 mb-1"><a href="pages-details.html">Acerola</a></h6>
                                                    <p class="mdtxt">Zara</p>
                                                </div>
                                            </div>
                                            <div class="btn-group bg-transparent cus-dropdown dropend">
                        ...
                        <div class="tab-pane fade" id="populer-tab-pane" role="tabpanel" aria-labelledby="populer-tab" tabindex="0">
                            <div class="row cus-mar friend-request">
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
                        ...
                        <div class="tab-pane fade" id="suggested-tab-pane" role="tabpanel" aria-labelledby="suggested-tab" tabindex="0">
                            <div class="row cus-mar friend-request">
                                <div class="col-xl-4 col-sm-6 col-8">
                                    <div class="single-box p-5">
                                        <div class="avatar-area">
