                            ...
                            <div class="page-details">
                                <ul class="nav mt-5 pt-4 flex-wrap gap-2 tab-area">
                                    <li class="nav-item" role="presentation">
                                        <a href="public-profile-post.html" class="nav-link d-center active">Post</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                    ...
                    <div class="profile-sidebar cus-scrollbar max-width p-5">
                        ...
                        <div class="sidebar-area mt-5">
                            ...
                            <ul class="d-grid gap-2 mt-4">
                                ...
                                <li class="d-flex align-items-center gap-2">
                                    <i class="material-symbols-outlined mat-icon"> flag </i>
                                    <span class="mdtxt link"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3c48594f487c515d5550125f5351">[email&#160;protected]</a></span>
                                </li>
                                <li class="d-flex align-items-center gap-2">
