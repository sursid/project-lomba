                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="gallery-item img-hover wow fadeInUp" data-wow-delay="0.3s">
                                                <div class="image hover-item">
                                                    <img class=" lazyload" src="./images/widget/gallery-item-9.jpg" data-src="./images/widget/gallery-item-9.jpg" alt="">
                                                </div>
                                                <a href="gallery" class="add-gallery">
                                                    +
                                                </a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="content-section img-hover">
                                <div class="image hover-item">
                                    <img src="./images/section/our-history.jpg" data-src="./images/section/our-history.jpg" alt="" class="lazyload">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box-about-us img-hover wow fadeInUp" data-wow-delay="0s">
                                <div class="image hover-item">
                                    <img src="./images/widget/about-us-1.jpg" data-src="./images/widget/about-us-1.jpg" alt="" class=" lazyload">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-md-6">
                            <div class="box-about-us img-hover wow fadeInUp" data-wow-delay="0.1s">
                                <div class="image hover-item">
                                    <img src="./images/widget/about-us-2.jpg" data-src="./images/widget/about-us-2.jpg" alt="" class=" lazyload">
                                </div>
                                <div class="content">
                                    <a href="event-detail" class="title fw-7 fs-30 font-worksans hover-text-secondary">
