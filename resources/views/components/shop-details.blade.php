                            ...
                            <div class="thumbs-slider sticky-top">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image item">
                                                <img src="./images/section/shop-detail-1.jpg" data-src="./images/section/shop-detail-1.jpg" data-zoom="./images/section/shop-detail-1.jpg" alt="" class="lazyload tf-image-zoom">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image item ">
                                                <img src="./images/section/shop-detail-2.jpg" data-src="./images/section/shop-detail-2.jpg" data-zoom="./images/section/shop-detail-2.jpg" alt="" class="lazyload  tf-image-zoom">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image item ">
                                                <img src="./images/section/shop-detail-3.jpg" data-src="./images/section/shop-detail-3.jpg" data-zoom="./images/section/shop-detail-3.jpg" alt="" class="lazyload tf-image-zoom">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image item">
                                                <img src="./images/section/shop-detail-4.jpg" data-src="./images/section/shop-detail-4.jpg" data-zoom="./images/section/shop-detail-4.jpg" alt="" class="lazyload tf-image-zoom">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-container tf-product-media-thumbs" data-direction="horizontal">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image item">
                                                <img src="./images/section/shop-detail-1.jpg" data-src="./images/section/shop-detail-1.jpg" alt="" class="lazyload">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image item">
                                                <img src="./images/section/shop-detail-2.jpg" data-src="./images/section/shop-detail-2.jpg" alt="" class="lazyload">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image item">
                                                <img src="./images/section/shop-detail-3.jpg" data-src="./images/section/shop-detail-3.jpg" alt="" class="lazyload">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image item">
                                                <img src="./images/section/shop-detail-4.jpg" data-src="./images/section/shop-detail-4.jpg" alt="" class="lazyload">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="notice-list">
                                    <li>
                                        <svg id="Layer_1" height="24" viewBox="0 0 512 512" width="24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
                                            <path d="m441.667 118.253-192-85.333a10.687 10.687 0 0 0 -8.667 0l-192 85.333a10.669 10.669 0 0 0 -6.333 9.747v234.667a10.669 10.669 0 0 0 6.333 9.747l192 85.333a10.673 10.673 0 0 0 8.667 0l192-85.333a10.669 10.669 0 0 0 6.333-9.747v-234.667a10.669 10.669 0 0 0 -6.333-9.747z" fill="#ff9500"></path>
                                            <path d="m249.667 457.747 192-85.333a10.669 10.669 0 0 0 6.333-9.747v-234.667a10.669 10.669 0 0 0 -6.333-9.747l-192-85.333a10.687 10.687 0 0 0 -4.334-.92v426.667a10.7 10.7 0 0 0 4.334-.92z" fill="#fbab01"></path>
                                            <path d="m245.333 213.333 201.65-89.622a10.572 10.572 0 0 0 -5.316-5.459l-192-85.333a10.687 10.687 0 0 0 -8.667 0l-192 85.334a10.572 10.572 0 0 0 -5.316 5.459z" fill="#fac100"></path>
                                            <path d="m156.467 173.837 205.133-91.17-26.265-11.673-205.133 91.17z" fill="#fbab01"></path>
                                            <circle cx="373.333" cy="362.667" fill="#00cf66" r="96"></circle>
                                            <path d="m389.333 437.333a90.608 90.608 0 0 1 -56.1-161.807 95.949 95.949 0 1 0 127.241 127.238 90.434 90.434 0 0 1 -71.141 34.569z" fill="#00b157"></path>
                                            <path d="m362.667 405.333a10.632 10.632 0 0 1 -7.542-3.125l-26.667-26.667a10.666 10.666 0 0 1 15.083-15.083l19.125 19.122 45.792-45.789a10.666 10.666 0 1 1 15.083 15.083l-53.333 53.333a10.632 10.632 0 0 1 -7.541 3.126z" fill="#eaeff0"></path>
                                        </svg>
                                        <p>
                                    ...
                                    <li>
                                        <svg height="18" viewBox="0 0 58 44" width="24" xmlns="http://www.w3.org/2000/svg">
                                            <g id="Page-1" fill="none" fill-rule="evenodd">
                                                <g>
                                                    <ellipse cx="14.5" cy="22" fill="#ecf0f1" rx="14.5" ry="22"></ellipse>
                                                    <ellipse cx="43.5" cy="22" fill="#ecf0f1" rx="14.5" ry="22"></ellipse>
                                                    <ellipse cx="12" cy="22" fill="#2fa8cc" rx="10" ry="15"></ellipse>
                                                    <ellipse cx="41" cy="22" fill="#2fa8cc" rx="10" ry="15"></ellipse>
                                                    <ellipse cx="11" cy="22" fill="#35495e" rx="7" ry="10"></ellipse>
                                                    <ellipse cx="40" cy="22" fill="#35495e" rx="7" ry="10"></ellipse>
                                                    <g fill="#ecf0f1">
                        ...
                        <div class="col-lg-12">
                            <div class="wg-tabs style-2">
                                <div class="flex justify-center">
                                    <ul class="menu-tab">
                                        <li class="item active"><a href="javascript:void(0)" class="btn-tab">Description</a></li>
                                        ...
                                        <div class="comment-wrap text-left">
                                            ...
                                            <div class="author-wrap">
                                                <div class="author">
                                                    ...
                                                    <div class="entry">
                                                        <a href="#" class="entry-name font-worksans fw-6 text-upper hover-text-secondary">Christine
                                                            Rose</a>
                                                        <p class=" font-nunito">
