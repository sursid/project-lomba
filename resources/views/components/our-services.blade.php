        ...
        <div class="main-content page-our-service page-our-commitments pb-0">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="image-wrap">
                                <div class="image">
                                    <img src="./images/widget/commitment.jpg" data-src="./images/widget/commitment.jpg" alt="" class="lazyload">
                                </div>
                            ...
                            <div class="grid-layout-3">
                                <div class="box-infor ic-hover img-hover style-1 wow fadeInUp" data-wow-delay="0s">
                                    <div class="image hover-icon hover-item">
                                        <img src="./images/widget/provide-item-1.jpg" data-src="./images/widget/provide-item-1.jpg" alt="" class=" lazyload">
                                ...
                                <div class="box-infor ic-hover img-hover style-1 wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="image hover-icon hover-item">
                                        <img src="./images/widget/provide-item-2.jpg" data-src="./images/widget/provide-item-2.jpg" alt="" class=" lazyload">
                                        <div class="icon style-circle">
                                            <i class="icon-cow"></i>
                                        </div>
                                    </div>
                                ...
                                <div class="box-infor ic-hover img-hover style-1 wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="image hover-icon hover-item">
                                        <img src="./images/widget/provide-item-3.jpg" data-src="./images/widget/provide-item-3.jpg" alt="" class=" lazyload">
                                        <div class="icon style-circle">
                                ...
                                <div class="box-infor ic-hover img-hover style-1 wow fadeInUp" data-wow-delay="0s">
                                    <div class="image hover-icon hover-item">
                                        <img src="./images/widget/provide-item-4.jpg" data-src="./images/widget/provide-item-4.jpg" alt="" class=" lazyload">
                                        <div class="icon style-circle">
                                ...
                                <div class="box-infor ic-hover img-hover style-1 wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="image hover-icon hover-item">
                                        <img src="./images/widget/provide-item-5.jpg" data-src="./images/widget/provide-item-5.jpg" alt="" class=" lazyload">
                                        <div class="icon style-circle">
                                ...
                                <div class="box-infor ic-hover img-hover style-1 wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="image hover-icon hover-item">
                                        <img src="./images/widget/provide-item-6.jpg" data-src="./images/widget/provide-item-6.jpg" alt="" class=" lazyload">
                                        <div class="icon style-circle">
            ...
            <section class="s-testimonial-2 style-2">
                ...
                <div class="s-img-item item-1 scroll-element-3">
                    <img src="./images/item/gree-field.jpg" data-src="./images/item/gree-field.jpg" alt="" class="lazyload scale-1-1">
                </div>
                <div class="s-img-item item-2">
                    <img src="./images/item/page-title-top.png" alt="">
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="content-left">
                                    ...
                                    <div class="image mb-30">
                                        <img src="./images/section/s-contact.jpg" alt="./images/section/s-contact.jpg" class="lazyload">
                            ...
                            <div class="col-lg-7">
                                <div class="content-section">
                                    ...
                                    <form id="contactform" method="post" action="./contact/contact-process.php" novalidate="novalidate" class="form-send-message">
                                            ...
                                            <div class="slide-partner">
                                                ...
                                                <div class="image">
                                                    <a href="#">
                                                        ...
                                                        <img src="./images/partner/strachan-valley.png" alt="" class="lazyload">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
